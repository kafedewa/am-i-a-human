        ...
        <div className='w-full pl-6 pr-6 mt-4'>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type='text' placeholder='Enter email' value={email} onChange={(e) => setEmail(e.target.value)} className='w-full input input-primary'/>
                </div>
                ...
                <div>
                    ...
                    <input type='password' placeholder='Enter password' value={password} onChange={(e) => setPassword(e.target.value)} className='w-full input input-primary'/>
                </div>
