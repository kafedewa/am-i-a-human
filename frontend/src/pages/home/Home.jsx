...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center h-dvh w-screen">
        <div className="navbar flex w-screen top-0 left-0 right-0">
            <div className="fixed top-6 right-6">
                <LogoutButton />
            </div>
      </div>
        <div className='flex flex-col w-screen h-full overflow-auto items-center justify-center'>
            <h1 className='flex text-center text-5xl ml-4 mr-4 pt-4 font-semibold text-black'>
                <span>Welcome, {authUser.fullName}!</span>
            </h1>
            <h3 className='flex text-lg text-center text-black mt-4 ml-4 mr-4'>
